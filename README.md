...
| `builder.html` | Lists all 22 rules with a switch on each and a second action on hold, assembling the file as you go. Clicking it here shows source, not a page — download it, or enable Pages. See `INDEX.md` |
